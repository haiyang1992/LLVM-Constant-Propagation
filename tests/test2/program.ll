...
entry:
  ...
  %call1 = call i64 @CAT_get_signed_value(i8* %d)
  ret i64 %call1
}
...
entry:
  ...
  %call3 = call i8* @CAT_create_signed_value(i64 5)
  %call4 = call i64 @foo2(i8* %call3)
  %call5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i32 0, i32 0), i64 %call4)
  ret i32 0
}
