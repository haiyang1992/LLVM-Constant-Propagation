...
entry:
  %call = call i8* @CAT_create_signed_value(i64 10)
  %call1 = call i8* @foo2(i8* %d)
  %call2 = call i64 @CAT_get_signed_value(i8* %d)
  ret i64 %call2
}
...
entry:
  ...
  %call1 = call i8* @foo2(i8* %call)
  %call2 = call i64 @foo(i8* %call1)
  %call3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i32 0, i32 0), i64 %call2)
  ret i32 0
}
